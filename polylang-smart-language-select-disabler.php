...
class PolylangSmartLanguageSelectDisabler {
	...
	public function maybe_disable_language_select( $current_screen ) {
		...
		if ( $disable_translations ) {
			add_action( 'in_admin_header', array( &$this, 'disable_language_select' ) );
		}

	} // end function maybe_disable_language_select

	/**
	 *  Disable language select styles and scripts.
	 */
	public function disable_language_select() {
		?>
		<style>
			/* Bulk edit */
		...
		<?php
	} // end function disable_language_select
